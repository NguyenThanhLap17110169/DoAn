...
namespace DoAn1
{
    class NhanVien
    {
        public bool insertNhanVien(string manv, string hoten, DateTime ngaysinh, string gioitinh, string diachi, string sđt, string trinhdo, string chucvu, string congviec, string phongban, MemoryStream hinhanh)
        {
            ...
            command.Parameters.Add("@ma", SqlDbType.NVarChar).Value = manv;
            ...
            command.Parameters.Add("@c", SqlDbType.NVarChar).Value = congviec;
            command.Parameters.Add("@pb", SqlDbType.NVarChar).Value = phongban;
